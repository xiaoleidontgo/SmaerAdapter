...
public class Type3Provider implements IProvider<TypeExample1> {
    @Override
    public int itemLayoutID() {
        return R.layout.item_type_e3;
    }
    ...
    public void onClick(View view, int position, TypeExample1 typeExample1) {
        Toast.makeText(view.getContext(), "Type3Provider onClick", Toast.LENGTH_SHORT).show();
    }

    @Override
    public boolean onLongClick(View view, int position, TypeExample1 typeExample1) {
        Toast.makeText(view.getContext(), "Type3Provider onLongClick", Toast.LENGTH_SHORT).show();
        return false;
    }
}
